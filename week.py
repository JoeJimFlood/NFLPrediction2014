...
matchups['Thursday Night'] = [('ATL', 'TB')]
matchups['Sunday Morning'] = [('BUF', 'SD'),            
                              ('STL', 'DAL'),
                              ('PHI', 'WAS'),
                              ('NYG', 'HOU'),
                              ('NO', 'MIN'),
                              ...
                              ('JAX', 'IND'),
                              ('OAK', 'NE')]
matchups['Sunday Afternoon'] = [('ARI', 'SF'),
                                ('SEA', 'DEN'),
                                ('MIA', 'KC')]            
matchups['Sunday Night'] = [('CAR', 'PIT')]
matchups['Monday Night'] = [('NYJ', 'CHI')]
